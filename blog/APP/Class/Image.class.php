...
Class Image {
	...
	Static Public function verify ($length = NULL, $width = NULL, $height = NULL) {
		...
		//从App/Conf/verify.php读取配置文件项
		//verify.php该配置文件是由System/updateVerify中的F方法缓存的
	...
	Static Public function water ($img, $water = '', $save = NULL) {
		...
		//从App/Conf/water.php读取配置文件项
		//water.php该配置文件是由System/updateWater中的F方法缓存的
